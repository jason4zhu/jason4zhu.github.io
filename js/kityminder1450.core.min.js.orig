    ...
    b[0] = {
        ...
        value: function(a, c, d) {
            ...
            f.register("arc_tp", function(a, b, c, d, f) {
                ...
                if (o = 0 == a.getIndex() ? .4 * o : o, e.Vector.fromPoints(l, m), n.push("M", l), n.push("A", o, o, 0, 0, 1, m), c.setMarker(g), g.dot.fill(f), c.setPathData(n), k && k.getConnection()) {
                    var p = k.getConnection(),
                        q = k.getLayoutBox(),
                        r = new e.Point(q.cx, q.cy),
                        s = Math.sqrt(Math.pow(m.x - r.x, 2) + Math.pow(m.y - r.y, 2));
                    n = [], n.push("M", m), n.push("A", s, s, 0, 0, 1, r), p.setMarker(g), g.dot.fill(f), p.setPathData(n)
                }
            })
        }
    }, b[2] = {
        ...
        value: function(a, c, d) {
            ...
            i.STATE_NORMAL = h, i.STATE_ACTIVE = 1, i.STATE_DISABLED = -1, e.extendClass(f, {
        ...
        value: function(a, c, d) {
            ...
            c.registerProtocol = e, c.getRegisterProtocol = f, g.extendClass(h, {
                ...
                exportData: function(a, b) {
                    var c, d;
                    return c = this.exportJson(), !a || (d = l[a]) && d.encode ? (this._fire(new i("beforeexport", {
                        json: c,
                        protocolName: a,
                        protocol: d
                ...
                importData: function(a, b, c) {
                    var d, e = this;
                    if (a && (!(d = l[a]) || !d.decode)) return k.reject(new Error("Not supported protocol:" + a));
                    var f = {
                        local: b,
                        protocolName: a,
                        protocol: d
        ...
        value: function(a, c, d) {
            var e = b.r(17),
                ...
                g = e.createClass("MindEvent", {
                    ...
                    getPosition: function(a) {
                        if (this.kityEvent) return a && "minder" != a ? this.kityEvent.getPosition.call(this.kityEvent, a) : this.kityEvent.getPosition(this.minder.getRenderContainer())
                    },
                    ...
                    isRightMB: function() {
                        var a = !1;
                        return !!this.originEvent && ("which" in this.originEvent ? a = 3 == this.originEvent.which : "button" in this.originEvent && (a = 2 == this.originEvent.button), a)
                    },
                    getKeyCode: function() {
            ...
            f.registerInitHook(function(a) {
                ...
                _listen: function(a, b) {
                    (this._eventCallbacks[a] || (this._eventCallbacks[a] = [])).push(b)
                },
                _fire: function(a) {
                    a.minder = this;
            ...
            g.registerInitHook(function(a) {
                ...
                _initKeyReceiver: function() {
                    if (!this._keyReceiver) {
                        ...
                        var b = this;
                        e(a, "keydown keyup keypress copy paste blur focus input", function(c) {
                            switch (c.type) {
                                case "blur":
                                    b.blur();
                                    break;
        ...
        value: function(a, c, d) {
            ...
            l.register = e, i.registerInitHook(function(a) {
                ...
                layout: function() {
                    function a(b, c) {
                        b.isExpanded(), b.children.forEach(function(b) {
                            a(b, c)
            ...
            var e = b.r(17),
                ...
                h = e.createClass("Minder", {
                    constructor: function(a) {
                        ...
                        for (var b, c = g.slice(); c.length;) "function" == typeof(b = c.shift()) && b.call(this, this._options);
                        this.fire("finishInitHook")
                    }
                });
            h.version = "1.4.43", h.registerInitHook = function(a) {
                g.push(a)
            }, d.exports = h
        }
    }, b[20] = {
        ...
        value: function(a, c, d) {
            ...
            function f(a, b) {
                ...
                if ("root" == f) {
                    ...
                    d = a.getRoot();
                    for (var i, j; i = c.shift();) "children" != i && (void 0 !== j && (d = d.getChild(j)), j = +i);
                    b.index = j, b.node = d
                }
                switch (b.express = [f, b.op].join(".")) {
                    ...
                    case "data.remove":
                        var k, l = b.node.data;
                        for (c = b.dataPath.slice(); l && c.length > 1;) k = c.shift(), k in l ? l = l[k] : "remove" != b.op && (l = l[k] = {});
                        l && (k = c.shift(), l[k] = b.value), "expandState" == k ? d.renderTree() : d.render(), a.layout()
                }
                a.fire("patch", {
                    patch: b
                })
        ...
        value: function(a, b, c) {
            var d = 0,
                ...
                g = function(a) {
                    ...
                    this.id = "Thenable/1.0.7", this.state = d, this.fulfillValue = void 0, this.rejectReason = void 0, this.onFulfilled = [], this.onRejected = [], "function" == typeof a && a.call(this, this.fulfill.bind(this), this.reject.bind(this))
                };
            g.prototype = {
                fulfill: function(a) {
                ...
                return new g(function(b, c) {
                    var d = a.length,
                        ...
                        f = 0,
                        g = [];
                    for (0 === d && b(g); e < d;) a[e].then(function(a) {
                        g.push(a), ++f === d && b(g)
                    }, function(a) {
                        c(a)
                    }), e++
            ...
            var h = function(a, b, c, e) {
                ...
                l = function(a, b) {
                    ...
                    if ("function" != typeof c) a.fulfill(b);
                        ...
                        try {
                            c.call(b, function(c) {
                                d || (d = !0, c === b ? a.reject(new TypeError("circular thenable chain")) : l(a, c))
                            }, function(b) {
                                d || (d = !0, a.reject(b))
                            })
                        } catch (b) {
        ...
        value: function(a, c, d) {
            ...
            var f = b.r(17),
                ...
                i = f.createClass("Renderer", {
                    ...
                    watchChange: function(a) {
                        void 0 === this.watchingData || this.watchingData, this.watchingData = a
                    },
            ...
            f.extendClass(g, e()), f.extendClass(h, {
                ...
                getRenderBox: function(a, b) {
                    ...
                    return f.Matrix.getCTM(this.getRenderContainer(), b || "paper").transformBox(d)
                }
            }), d.exports = i
        }
    }, b[28] = {
                    ...
                    this.on("keydown", function(b) {
                        for (var c in a)
                            if (a.hasOwnProperty(c) && b.isShortcutKey(c)) {
                                var d = a[c];
                                if (d.__statusCondition && d.__statusCondition != this.getStatus()) return;
                                d(), b.preventDefault()
                            }
                    })
                },
        ...
        value: function(a, c, d) {
            ...
            c.register = e, g.extend(h, {
                ...
                return {
                    ...
                    getTheme: function(b) {
                        return (this.getTemplateSupport("getTheme") || a).call(this, b)
                    }
                }
                ...
                return {
                    getLayout: function() {
                        return (this.getMinder().getTemplateSupport("getLayout") || a).call(this, this)
                    },
                    getConnect: function() {
                        return (this.getMinder().getTemplateSupport("getConnect") || b).call(this, this)
                    }
                }
        ...
        value: function(a, c, d) {
            ...
            g.extendClass(h, {
                arrange: function(a) {
                    ...
                    if (b) {
                        var c = b.children;
                        if (!(a < 0 || a >= c.length)) return c.splice(this.getIndex(), 1), c.splice(a, 0, this), this
                    }
                }
            });
                        ...
                        if (c.length) {
                            if (h.getCommonAncestor(c) == c[0].parent) {
                                var d = c.map(function(a) {
                                    ...
                                    e = Math.min.apply(Math, d.map(function(a) {
                                        return a.index
                                    })) >= b;
                                d.sort(function(a, b) {
            ...
            var e = b.r(17),
                ...
                i = e.createClass("MoveToParentCommand", {
                    ...
                    execute: function(a, b, c) {
                        for (var d, e = 0; e < b.length; e++) d = b[e], d.parent && (d.parent.removeChild(d), c.appendChild(d), d.render());
                ...
                l = e.createClass("TreeDragger", {
                    ...
                    dragMove: function(a) {
                        if (this._startPosition) {
                            var b = e.Vector.fromPoints(this._dragPosition || this._startPosition, a),
                                c = this._minder;
                            if (this._dragPosition = a, !this._dragMode) {
                                if (e.Vector.fromPoints(this._dragPosition, this._startPosition).length() < 10) return;
                                if (!this._enterDragMode()) return
                            }
                            for (var d = 0; d < this._dragSources.length; d++) this._dragSources[d].setLayoutOffset(this._dragSources[d].getLayoutOffset().offset(b)), c.applyLayoutResult(this._dragSources[d]);
                    ...
                    dragEnd: function() {
                        if (this._startPosition = null, this._dragPosition = null, this._dragMode) {
                            if (this._fadeDragSources(1), this._dropSucceedTarget) this._dragSources.forEach(function(a) {
                                ...
                                b < e && "down" == a.type && b++, b > d && "up" == a.type && b--, a.node.setLayoutOffset(null), this._minder.execCommand("arrange", b), this._renderOrderHint(null)
                    ...
                    _dropTest: function() {
                        return this._dropSucceedTarget = this._boxTest(this._dropTargets, function(a, b) {
                            ...
                            return !!a && (!!d(a) && (d(a) > .5 * Math.min(d(b), d(c)) || (a.width + 1 >= Math.min(b.width, c.width) || a.height + 1 >= Math.min(b.height, c.height))))
        ...
        value: function(a, c, d) {
            ...
            j.register("Expand", function() {
                ...
                e.extendClass(h, {
                    ...
                    isExpanded: function() {
                        return this.getData(b) !== c && (this.isRoot() || this.parent.isExpanded())
                    },
                ...
                var d = e.createClass("ExpandCommand", {
                    ...
                    m = e.createClass("Expander", {
                        ...
                        setState: function(a) {
                            ...
                            a == c && b.push(["M", 0, 1.5 - this.radius, "L", 0, this.radius - 1.5]), this.sign.setPathData(b)
                        }
                    }),
                    n = e.createClass("ExpanderRenderer", {
                        base: k,
                        create: function(a) {
                            if (!a.isRoot()) return this.expander = new m(a), a.getRenderContainer().prependShape(this.expander), a.expanderRenderer = this, this.node = a, this.expander
                        },
                        shouldRender: function(a) {
                            return !a.isRoot()
                        },
                    ...
                    events: {
                        ...
                        "normal.keydown": function(a) {
                            if ("textedit" != this.getStatus()) {
                                ...
                                for (var d = 1; d < 6; d++) a.isShortcutKey("Alt+" + d) && this.execCommand("expandtolevel", d)
                            }
                        }
                    },
                    renderers: {
                ...
                renderers: {
                    right: e.createClass("hyperlinkrender", {
                        ...
                        update: function(a, b, c) {
                            ...
                            a.setHref("#");
                            // MARK: 增加页面内部anchor链接
                            for (var f = ["^#", "^http:", "^https:", "^ftp:", "^mailto:"], g = 0; g < f.length; g++)
                                if (new RegExp(f[g]).test(d)) {
                                    if(new RegExp(f[0]).test(d) && $(document).find(".c_post_page").length > 0)	{
                                        a.setHref(d);
                                    	a.setAttr("target", "_self");
                                    } 
                                    else if (new RegExp(f[0]).test(d) && $(document).find(".c_post_page").length <= 0) {
                                        // delete <a>
                                        a.remove();
                                    }
                                    else {
                            ...
                            // END
                            h = h ? [h, "(", d, ")"].join("") : d, a.node.setAttributeNS("http://www.w3.org/1999/xlink", "title", h);
                            var i = b.getStyle("space-right");
                            return a.setTranslate(c.right + i + 2, -5), new e.Box({
                                x: c.right + i,
                                y: -11,
                                width: 24,
                                height: 22
        ...
        value: function(a, c, d) {
            ...
            g.register("ImageViewer", function() {
                function a(a, b, d) {
                    ...
                    return c(e, b), d && d.length && d.forEach(function(a) {
                        e.appendChild(a)
                    }), e
                }
                ...
                var d = e.createClass("ImageViewer", {
                    constructor: function() {
                        var c = a("button", "km-image-viewer-btn km-image-viewer-close"),
                            ...
                            e = this.image = a("img"),
                            f = this.toolbar = a("div", "km-image-viewer-toolbar", [d, c]),
                            g = a("div", "km-image-viewer-container", [e]),
                            h = this.viewer = a("div", "km-image-viewer", [f, g]);
                        this.hotkeyHandler = this.hotkeyHandler.bind(this), b(c, "click", this.close.bind(this)), b(d, "click", this.viewSource.bind(this)), b(e, "click", this.zoomImage.bind(this)), b(h, "contextmenu", this.toggleToolbar.bind(this)), b(document, "keydown", this.hotkeyHandler)
                    },
                    dispose: function() {
                    ...
                    zoomImage: function(a) {
                        var b = this.image;
                        "boolean" == typeof a ? a && c(b, "limited") : b.classList.toggle("limited")
                    },
                    ...
                    open: function(a) {
                        ...
                        b && (b.focus(), b.blur()), this.image.src = a, this.zoomImage(!0), document.body.appendChild(this.viewer), this.actived = !0
                    },
                    close: function() {
                        this.image.src = "", document.body.removeChild(this.viewer), this.actived = !1
                    }
                });
                return {
                    init: function() {
                    ...
                    events: {
                        "normal.dblclick": function(a) {
                            ...
                            "Image" === b.__KityClassName && b.url && this.viewer.open(b.url)
                        }
                    }
                }
            })
        ...
        value: function(a, c, d) {
            ...
            e.register("KeyboardModule", function() {
                ...
                function b(a, b) {
                    var c, d, h, i, j, k, l;
                    c = e(a.left, b.left), d = f(a.right, b.right), h = e(a.top, b.top), i = f(a.bottom, b.bottom), j = d - c - a.width - b.width, k = i - h - a.height - b.height, l = j < 0 ? k : k < 0 ? j : g(j * j + k * k);
                    var m = a.node,
                        n = b.node;
            ...
            var e = b.r(17),
                ...
                i = e.createClass("OutlineRenderer", {
                    ...
                    update: function(a, b, c) {
                        ...
                        if (d && "circle" == d) {
                            var l = Math.pow;
                            k = (0, Math.round)(Math.sqrt(l(j.width, 2) + l(j.height, 2)) / 2), j.x = c.cx - k, j.y = c.cy - k, j.width = 2 * k, j.height = 2 * k
                        }
                        var m = b.isSelected() ? b.getMinder().isFocused() ? "selected-" : "blur-selected-" : "";
                        return a.setPosition(j.x, j.y).setSize(j.width, j.height).setRadius(k).fill(b.getData("background") || b.getStyle(m + "background") || b.getStyle("background")).stroke(b.getStyle(m + "stroke" || b.getStyle("stroke")), b.getStyle(m + "stroke-width")), new e.Box(j)
                    }
                }),
            ...
            h.register("PriorityModule", function() {
                var a = [null, ["#FF1200", "#840023"],
                    ...
                    h = e.createClass("PriorityIcon", {
                        ...
                        create: function() {
                            var a, d, f;
                            (new e.Path).setPathData(c).fill("white"), a = (new e.Path).setPathData(b).setTranslate(.5, .5), d = (new e.Path).setPathData(c).setOpacity(.8).setTranslate(.5, .5), f = (new e.Text).setX(this.width / 2 - .5).setY(this.height / 2).setTextAnchor("middle").setVerticalAlign("middle").setFontItalic(!0).setFontSize(12).fill("white"), this.addShapes([a, d, f]), this.mask = d, this.back = a, this.number = f
                        },
                        setValue: function(b) {
                            var c = this.back,
                                d = this.mask,
            ...
            h.register("Resource", function() {
                var a = function() {
                        ...
                        return k = 4 * (1 << 30), a = [1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225], e = [608135816, 2242054355, 320440878, 57701188, 2752067618, 698298832, 137296536, 3964562569, 1160258022, 953160567, 3193202383, 887688300, 3232508343, 3380367581, 1065670069, 3041331479], j = function(a) {
                                return a < 0 && (a += k), ("00000000" + a.toString(16)).slice(-8)
                            }, f = [
                            ...
                            function(f, g) {
                                ...
                                var k, l, m, n, o, p, q, r;
                                for (l = a.slice(0), k = e.slice(0, 8), c = 0; c < 4; c += 1) k[c] ^= g[c];
                                ...
                                for (i.push(0), i.push(m), p = i.length - 16, q = 0, d = 0; d < i.length; d += 16) {
                                    for (q += 512, n = d === p ? o : Math.min(m, q), h = l.concat(k), h[12] ^= n, h[13] ^= n, c = 0; c < 10; c += 1)
                                        for (r = 0; r < 8; r += 1) r < 4 ? b(r, r, r, r, r) : b(r, r, r + 1, r + 2, r + 3);
                                    for (r = 0; r < 8; r += 1) l[r] ^= g[r % 4] ^ h[r] ^ h[r + 8]
                                }
                                return l.map(j).join("")
                            }
                    }(),
                ...
                e.extendClass(f, {
                    ...
                    getResourceColor: function(a) {
                        ...
                        return Object.prototype.hasOwnProperty.call(d, a) || (c = this._getNextResourceColorIndex(), d[a] = c), b[d[a]] || e.Color.createHSL(Math.floor(this.getHashCode(a) / 2147483647 * 359), 100, 85)
                    },
                    ...
                    _getNextResourceColorIndex: function() {
                        ...
                        c = [];
                        for (a in e) Object.prototype.hasOwnProperty.call(e, a) && c.push(e[a]);
                        for (d = 0; d < b.length; d++)
                    ...
                    c = function() {
                        ...
                        return {
                            selectStart: function(a) {
                                if (!a.originEvent.button && !a.originEvent.altKey) return c ? this.selectEnd() : void(c = a.getPosition(b).round())
                            },
                            selectMove: function(g) {
                                if ("textedit" != a.getStatus() && c) {
                                    ...
                                    var j = new e.Box(h.x, h.y, i.x - h.x, i.y - h.y),
                                        k = [];
                                    j.left = Math.round(j.left), j.top = Math.round(j.top), j.right = Math.round(j.right), j.bottom = Math.round(j.bottom), d.getDrawer().pipe(function() {
                                    ...
                                    }), a.select(k, !0), window.getSelection().removeAllRanges()
                                }
                            },
                ...
                return {
                    ...
                    events: {
                        ...
                        mouseup: function(a) {
                            ...
                            if (b && b == d) {
                                var g = a.getPosition();
                                e.Vector.fromPoints(f, g).length() < 1 && this.select(d, !0), d = null
                            }
                            c.selectEnd(a)
                        },
                        "normal.keydown": function(a) {
                ...
                l = e.createClass("TextRenderer", {
                    ...
                    update: function(a, b) {
                        ...
                        if (u < v)
                            ...
                            for (var w = u - v; w--;) s = (new e.Text).setAttr("text-rendering", "inherit"), e.Browser.ie || e.Browser.edge ? s.setVerticalAlign("top") : s.setAttr("dominant-baseline", "text-before-edge"), a.addItem(s);
            ...
            var e = b.r(17),
                ...
                h = (b.r(27), e.createClass("ViewDragger", {
                    ...
                    getView: function() {
                        ...
                        return a.getPaper().getViewPortMatrix().inverse().translate(-c.x, -c.y).transformBox(d)
                    },
                    _bind: function() {
                        function a(a) {
                            if (d) {
                                d = null, a.stopPropagation(), c && (b.setEnabled(!1), c = !1, "hand" == b._minder.getStatus() && b._minder.rollbackStatus());
                                b._minder.getPaper().setStyle("cursor", "hand" == b._minder.getStatus() ? "-webkit-grab" : "default"), b._minder.fire("viewchanged")
                            }
                        }
                        var b = this,
                            c = !1,
                        ...
                        this._minder.on("normal.mousedown normal.touchstart inputready.mousedown inputready.touchstart readonly.mousedown readonly.touchstart", function(a) {
                            ...
                            if ("touchmove" == a.type && a.preventDefault(), c) {
                                if (e.Vector.fromPoints(d, a.getPosition("view")).length() > 10) {
                                    this.setStatus("hand", !0);
                                    b._minder.getPaper().setStyle("cursor", "-webkit-grabbing")
                                }
                            }
        ...
        value: function(a, c, d) {
            ...
            h.register("Zoom", function() {
                ...
                function b(a) {
                    var b = a.shapeNode,
                        c = b.getCTM(),
                        d = new e.Matrix(c.a, c.b, c.c, c.d, .5 + (0 | c.e), .5 + (0 | c.f));
                        ...
                        "normal.mousewheel readonly.mousewheel": function(a) {
                            if (a.originEvent.ctrlKey || a.originEvent.metaKey) {
                                ...
                                e.Browser.mac || (b = -b), Math.abs(b) > 100 && (clearTimeout(this._wheelZoomTimeout), this._wheelZoomTimeout = setTimeout(function() {
                                    c.getPaper()._zoom;
                                    b < 0 ? c.execCommand("zoomin") : b > 0 && c.execCommand("zoomout")
        ...
        value: function(a, c, d) {
            function e(a, b) {
                return new k(function(b, c) {
                    ...
                    d.onload = function() {
                        ...
                        c(a)
                    }, d.crossOrigin = "anonymous", d.src = a.url
                })
            }
            ...
            function f(a, b) {
                return k(function(b, c) {
                    ...
                    d.open("GET", a.url + "?_=" + Date.now(), !0), d.responseType = "blob", d.onreadystatechange = function() {
                        if (4 === d.readyState && 200 === d.status) {
                            var c = d.response,
                                e = document.createElement("img");
                            e.src = l.createObjectURL(c), e.onload = function() {
                                l.revokeObjectURL(e.src), b({
                                    element: e,
                                    x: a.x,
                                    y: a.y,
                                    width: a.width,
            ...
            function h(a, b, c) {
                function d(a, b) {
                    a.save(), a.fillStyle = b, a.fillRect(0, 0, o.width, o.height), a.restore()
                }

                function h(a, b, c, d, e, f) {
                    e && f ? a.drawImage(b, c + A, d + A, e, f) : a.drawImage(b, c + A, d + A)
                }
                ...
                function n() {
                    return e({
                        ...
                        for (var b = 0; b < a.length; b++) h(p, a[b].element, a[b].x + w, a[b].y + x, a[b].width, a[b].height);
                ...
                var o = document.createElement("canvas"),
                    ...
                    x = c && c.height && c.height > t.height ? (c.height - t.height) / 2 : 0,
                    y = t.dataUrl,
                    z = t.imagesInfo,
                    A = 20;
            ...
            j.registerProtocol("png", d.exports = {
        ...
        value: function(a, c, d) {
            ...
            function f(a) {
                if (!a) return "";
                for (var b = [], c = ["\\", "n"], d = 0, e = 0, f = a.length; d < f; d++)
                    if ("\n" !== a[d] && "\r" !== a[d])
                        if (a[d] !== c[e]) {
                            switch (e) {
                                case 0:
        ...
        value: function(a, c, d) {
            b.r(31).register("tianpan", {
                getLayout: function(a) {
                    return a.getData("layout") ? a.getData("layout") : 0 === a.getLevel() ? "tianpan" : a.parent.getLayout()
                },
                getConnect: function(a) {
                    return "arc_tp"
                }
