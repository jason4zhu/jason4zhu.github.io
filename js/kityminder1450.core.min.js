                ...
                right: kity.createClass("hyperlinkrender", {
                    ...
                    update: function(link, node, box) {
                        ...
                        for (var i = 0; i < allowed.length; i++) {
                            ...
                            if (regex.test(href)) {
                                if(new RegExp(allowed[0]).test(href) && $(document).find(".c_post_page").length > 0) {
                                    link.setHref(href);
                                    link.setAttr("target", "_self");
                                }
                                else if (new RegExp(allowed[0]).test(href) && $(document).find(".c_post_page").length <= 0) {
                                    link.remove();
                                }
                                else{
                                    link.setHref(href);
